              ...
              itemBuilder: (BuildContext context, int index){
                return AutoScrollTag(
                  ...
                  child: index==list.length-1 ? 
                    Column(
                      children: [
                        Obx(() => songItem(artist: list[index]["artist"], duration: list[index]["duration"], index: index, title: list[index]["title"], isLoved: operations().isLoved(list[index]["id"]), playSong: ()=>playSongFromPlaylist(index), isPlaying: isPlaying(index), id: c.nowPage["id"],),),
                        SizedBox(height: 120,),
                      ],
                    ):
                    Obx(() => songItem(artist: list[index]["artist"], duration: list[index]["duration"], index: index, title: list[index]["title"], isLoved: operations().isLoved(list[index]["id"]), playSong: ()=>playSongFromPlaylist(index), isPlaying: isPlaying(index), id: c.nowPage["id"],),),
