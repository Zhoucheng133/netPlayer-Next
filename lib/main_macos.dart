...
class main_macos extends StatefulWidget {
  const main_macos({super.key});

  @override
  State<main_macos> createState() => _main_macosState();
}

class _main_macosState extends State<main_macos> {
